  ...
  return (
    <>
      ...
      {widgets.length > 0 && (
        <div
          dir="rtl"
          className="space-y-4 border-t border-slate-200 bg-black px-6 py-8 md:px-10"
        >
      ...
      <div
        dir="rtl"
        className="border-t border-dashed border-slate-200 bg-slate-50/50 px-6 py-10 md:px-10"
      >
        <button
          type="button"
          onClick={(e) => {
          ...
          className="group mx-auto flex w-full max-w-md items-center justify-center gap-3 rounded-2xl border-2 border-dashed border-slate-200 bg-white shadow-sm py-6 text-sm font-bold text-slate-600 transition-all hover:-translate-y-0.5 hover:border-emerald-500 hover:bg-emerald-500/5 hover:text-emerald-600 hover:shadow-lg hover:shadow-[#C9A24A]/10"
        >
    ...
    <div
      ...
      className={`group relative cursor-pointer rounded-xl transition-all ${
        selected
          ...
          : "ring-1 ring-transparent hover:ring-1 hover:ring-emerald-500/40"
      }`}
    >
      <div
        className={`absolute -top-3 left-2 z-20 flex items-center gap-1 rounded-full bg-slate-50 px-1 py-1 shadow-lg shadow-black/50 ring-1 ring-white/10 transition-opacity ${
...
function LibraryOverlay({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative ml-auto h-full w-[360px] shrink-0 border-l border-slate-200 bg-slate-50 shadow-2xl shadow-black/60"
      ...
      >
        ...
        <button
          type="button"
          onClick={onClose}
          className="absolute left-2 top-2 z-10 flex size-9 items-center justify-center rounded-lg text-slate-600 hover:bg-slate-50 hover:text-slate-900"
          aria-label="סגור"
        >
